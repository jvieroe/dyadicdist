...
#' @param longitude name of the numeric longitude variable. Defaults to c("longitude", "longitude")
#' @param latitude name of the numeric latitude variable. Defaults to c("latitude", "latitude")
#' @param crs a valid EPSG for a valid Coordinate Reference System (CRS) for your coordinates. Defaults to c(4326, 4326).
