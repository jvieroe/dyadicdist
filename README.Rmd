...
Let's have a look at the data from a more obvious point of view: the cities' geographic location in the US!
...
By default, `ddist()` returns the full list of dyadic distances between any points `i` and `j`, including cases where `j = i`. 
